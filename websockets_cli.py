...
async def receiver():
    ...
    async with websockets.connect(uri) as websocket:
        ...
        # Receive till get n number of messages
        n = 10000
        ...
        while True:
            ...
            if messages_received % n == 0: break

        finish_time = time.time()
        print(f'Got all {n} messages in {round(finish_time-start_time, 2)} seconds!')
